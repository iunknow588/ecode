...
function Resolve-RepoRoot {
    ...
    if (-not $RepoRootOverride) {
        throw "REPO_ROOT_OVERRIDE is required. Set it in scripts/git/.env."
    }
    if (-not (Test-Path $RepoRootOverride)) {
        throw "Configured REPO_ROOT_OVERRIDE does not exist: $RepoRootOverride"
    }
